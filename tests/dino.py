...
class MainSection(GameSection):
    def on_start(self):
        ...
        self.dino = GameImage('tests\\assets\\dino.png', (100,400))
        self.jumping = False
        self.jump_count = 10

        self.cactus = GameImage('tests\\assets\\cactus.png', (500, 400))
        self.gameover = False
        self.gameoversound = GameAudio('tests\\assets\\dead.wav')
